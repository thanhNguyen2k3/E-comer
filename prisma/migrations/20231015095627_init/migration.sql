...
CREATE TABLE "ShipOption" (
    ...
    CONSTRAINT "ShipOption_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_shipId_fkey" FOREIGN KEY ("shipId") REFERENCES "ShipOption"("id") ON DELETE SET NULL ON UPDATE CASCADE;
